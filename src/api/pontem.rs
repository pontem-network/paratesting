...
pub mod api {
	...
	pub mod system {
		...
		pub mod calls {
			...
			pub struct SetStorage {
				pub items:
					::std::vec::Vec<(::std::vec::Vec<::core::primitive::u8>, ::std::vec::Vec<::core::primitive::u8>)>,
			}
		...
		pub mod storage {
			...
			impl ::subxt::StorageEntry for BlockWeight {
				...
				type Value = runtime_types::frame_support::weights::PerDispatchClass<::core::primitive::u64>;
				fn key(&self) -> ::subxt::StorageEntryKey { ::subxt::StorageEntryKey::Plain }
			}
			...
			impl ::subxt::StorageEntry for Digest {
				...
				type Value = runtime_types::sp_runtime::generic::digest::Digest<::subxt::sp_core::H256>;
				fn key(&self) -> ::subxt::StorageEntryKey { ::subxt::StorageEntryKey::Plain }
			}
			pub struct Events;
	...
	pub mod timestamp {
		...
		pub mod calls {
			...
			{
				pub fn new(client: &'a ::subxt::Client<T>) -> Self { Self { client } }
				pub fn set(&self, now: ::core::primitive::u64) -> ::subxt::SubmittableExtrinsic<T, Set> {
					let call = Set { now };
					::subxt::SubmittableExtrinsic::new(self.client, call)
				}
			}
		...
		pub mod storage {
			...
			impl<'a, T: ::subxt::Config> StorageApi<'a, T> {
				...
				pub async fn next_fee_multiplier(
					&self,
					hash: ::core::option::Option<T::Hash>)
					-> ::core::result::Result<runtime_types::sp_arithmetic::fixed_point::FixedU128, ::subxt::Error> {
				...
				pub async fn storage_version(
					&self,
					hash: ::core::option::Option<T::Hash>)
					-> ::core::result::Result<runtime_types::pallet_transaction_payment::Releases, ::subxt::Error> {
	...
	pub mod sudo {
		...
		pub mod calls {
			...
			#[derive(:: subxt :: codec :: Encode, :: subxt :: codec :: Decode)]
			pub struct SetKey {
				pub new: ::subxt::sp_runtime::MultiAddress<::subxt::sp_core::crypto::AccountId32, ()>,
			}
			...
			#[derive(:: subxt :: codec :: Encode, :: subxt :: codec :: Decode)]
			pub struct SudoAs {
				pub who: ::subxt::sp_runtime::MultiAddress<::subxt::sp_core::crypto::AccountId32, ()>,
				pub call: runtime_types::pontem_runtime::Call,
			}
				...
				where T: ::subxt::Config + ::subxt::ExtrinsicExtraData<T>
			{
				...
				pub fn sudo_unchecked_weight(&self,
				                             call: runtime_types::pontem_runtime::Call,
		...
		pub mod events {
			use super::runtime_types;
			#[derive(:: subxt :: codec :: Encode, :: subxt :: codec :: Decode)]
			pub struct Sudid(pub ::core::result::Result<(), runtime_types::sp_runtime::DispatchError>);
		...
		pub mod storage {
			...
			impl<'a, T: ::subxt::Config> StorageApi<'a, T> {
				...
				pub async fn parachain_id(
					&self,
					hash: ::core::option::Option<T::Hash>)
					-> ::core::result::Result<runtime_types::polkadot_parachain::primitives::Id, ::subxt::Error> {
	...
	pub mod balances {
		...
		pub mod calls {
			...
			#[derive(:: subxt :: codec :: Encode, :: subxt :: codec :: Decode)]
			pub struct Transfer {
				pub dest: ::subxt::sp_runtime::MultiAddress<::subxt::sp_core::crypto::AccountId32, ()>,
				#[codec(compact)]
		...
		pub mod storage {
			...
			impl<'a, T: ::subxt::Config> StorageApi<'a, T> {
				pub fn new(client: &'a ::subxt::Client<T>) -> Self { Self { client } }
				pub async fn total_issuance(&self,
				                            hash: ::core::option::Option<T::Hash>)
				                            -> ::core::result::Result<::core::primitive::u64, ::subxt::Error> {
	...
	pub mod vesting {
		...
		pub mod calls {
				...
				where T: ::subxt::Config + ::subxt::ExtrinsicExtraData<T>
			{
				...
				pub fn force_vested_transfer(&self,
				                             source : :: subxt :: sp_runtime :: MultiAddress < :: subxt :: sp_core :: crypto :: AccountId32 , () >,
				                             target : :: subxt :: sp_runtime :: MultiAddress < :: subxt :: sp_core :: crypto :: AccountId32 , () >,
				                             schedule : runtime_types :: pallet_vesting :: vesting_info :: VestingInfo < :: core :: primitive :: u64 , :: core :: primitive :: u32 >)
	...
	pub mod parachain_staking {
		...
		pub mod calls {
			...
			pub struct SetStakingExpectations {
				pub expectations: runtime_types::parachain_staking::inflation::Range<::core::primitive::u64>,
			}
			...
			{
				pub fn new(client: &'a ::subxt::Client<T>) -> Self { Self { client } }
				pub fn set_staking_expectations(&self,
				...
				pub fn set_parachain_bond_account(&self,
				...
				pub fn set_collator_commission(&self,
				...
				pub fn set_blocks_per_round(&self,
				                            new: ::core::primitive::u32)
				...
				pub fn nominator_bond_more(&self,
				...
				pub fn nominator_bond_less(&self,
				                           candidate: ::subxt::sp_core::crypto::AccountId32,
				                           less: ::core::primitive::u64)
		...
		pub mod storage {
			...
			impl ::subxt::StorageEntry for Round {
				...
				type Value = runtime_types::parachain_staking::pallet::RoundInfo<::core::primitive::u32>;
				fn key(&self) -> ::subxt::StorageEntryKey { ::subxt::StorageEntryKey::Plain }
			}
			...
			impl ::subxt::StorageEntry for ExitQueue {
				...
				type Value = ::std::vec::Vec<(::subxt::sp_core::crypto::AccountId32, ::core::primitive::u32)>;
				fn key(&self) -> ::subxt::StorageEntryKey { ::subxt::StorageEntryKey::Plain }
			}
			...
			pub struct AtStake(::core::primitive::u32, ::subxt::sp_core::crypto::AccountId32);
			...
			pub struct AwardedPts(::core::primitive::u32, ::subxt::sp_core::crypto::AccountId32);
			...
			impl<'a, T: ::subxt::Config> StorageApi<'a, T> {
				...
				pub async fn collator_commission(
					&self,
					hash: ::core::option::Option<T::Hash>)
					-> ::core::result::Result<runtime_types::sp_arithmetic::per_things::Perbill, ::subxt::Error> {
					let entry = CollatorCommission;
					self.client.storage().fetch_or_default(&entry, hash).await
				}
				pub async fn total_selected(&self,
				                            hash: ::core::option::Option<T::Hash>)
				                            -> ::core::result::Result<::core::primitive::u32, ::subxt::Error> {
				...
				pub async fn nominator_state2_iter(
					&self,
					hash: ::core::option::Option<T::Hash>)
					-> ::core::result::Result<::subxt::KeyIter<'a, T, NominatorState2>, ::subxt::Error> {
					self.client.storage().iter(hash).await
		...
		pub mod storage {
			...
			impl<'a, T: ::subxt::Config> StorageApi<'a, T> {
				...
				pub async fn eligible_ratio(
					&self,
					hash: ::core::option::Option<T::Hash>)
					-> ::core::result::Result<runtime_types::sp_arithmetic::per_things::Percent, ::subxt::Error> {
	...
	pub mod author_mapping {
		...
		pub mod calls {
				...
				where T: ::subxt::Config + ::subxt::ExtrinsicExtraData<T>
			{
				...
				pub fn update_association(&self,
		...
		pub mod storage {
			...
			impl<'a, T: ::subxt::Config> StorageApi<'a, T> {
				...
				pub async fn mapping_with_deposit_iter(
					&self,
					hash: ::core::option::Option<T::Hash>)
					-> ::core::result::Result<::subxt::KeyIter<'a, T, MappingWithDeposit>, ::subxt::Error> {
					self.client.storage().iter(hash).await
				}
			}
		}
	...
	pub mod scheduler {
		...
		pub mod calls {
			...
			pub struct Schedule {
				...
				pub maybe_periodic: ::core::option::Option<(::core::primitive::u32, ::core::primitive::u32)>,
				...
				where T: ::subxt::Config + ::subxt::ExtrinsicExtraData<T>
			{
				...
				pub fn schedule_named_after(&self,
				                            id: ::std::vec::Vec<::core::primitive::u8>,
				                            after: ::core::primitive::u32,
				                            maybe_periodic: ::core::option::Option<(
					::core::primitive::u32,
	...
	pub mod treasury {
		...
		pub mod calls {
			...
			pub struct ProposeSpend {
				#[codec(compact)]
				pub value: ::core::primitive::u64,
				pub beneficiary: ::subxt::sp_runtime::MultiAddress<::subxt::sp_core::crypto::AccountId32, ()>,
			}
		...
		pub mod storage {
			...
			impl<'a, T: ::subxt::Config> StorageApi<'a, T> {
				pub fn new(client: &'a ::subxt::Client<T>) -> Self { Self { client } }
				pub async fn proposal_count(&self,
				                            hash: ::core::option::Option<T::Hash>)
				                            -> ::core::result::Result<::core::primitive::u32, ::subxt::Error> {
	...
	pub mod democracy {
		...
		pub mod calls {
			...
			pub struct Vote {
				...
				pub vote: runtime_types::pallet_democracy::vote::AccountVote<::core::primitive::u64>,
			}
				...
				where T: ::subxt::Config + ::subxt::ExtrinsicExtraData<T>
			{
				...
				pub fn clear_public_proposals(&self) -> ::subxt::SubmittableExtrinsic<T, ClearPublicProposals> {
		...
		pub mod storage {
			...
			impl ::subxt::StorageEntry for DepositOf {
				...
				type Value = (::std::vec::Vec<::subxt::sp_core::crypto::AccountId32>, ::core::primitive::u64);
				fn key(&self) -> ::subxt::StorageEntryKey {
					:: subxt :: StorageEntryKey :: Map (vec ! [:: subxt :: StorageMapKey :: new (& self . 0 , :: subxt :: StorageHasher :: Twox64Concat)])
				}
			}
			...
			impl ::subxt::StorageEntry for Blacklist {
				...
				type Value = (::core::primitive::u32, ::std::vec::Vec<::subxt::sp_core::crypto::AccountId32>);
				fn key(&self) -> ::subxt::StorageEntryKey {
					::subxt::StorageEntryKey::Map(vec![::subxt::StorageMapKey::new(
						&self.0,
						::subxt::StorageHasher::Identity,
			...
			impl<'a, T: ::subxt::Config> StorageApi<'a, T> {
				pub fn new(client: &'a ::subxt::Client<T>) -> Self { Self { client } }
				pub async fn public_prop_count(&self,
				                               hash: ::core::option::Option<T::Hash>)
				                               -> ::core::result::Result<::core::primitive::u32, ::subxt::Error> {
				...
				pub async fn referendum_count(&self,
				                              hash: ::core::option::Option<T::Hash>)
				                              -> ::core::result::Result<::core::primitive::u32, ::subxt::Error> {
					let entry = ReferendumCount;
					self.client.storage().fetch_or_default(&entry, hash).await
				}
				pub async fn lowest_unbaked(&self,
				                            hash: ::core::option::Option<T::Hash>)
				                            -> ::core::result::Result<::core::primitive::u32, ::subxt::Error> {
				...
				pub async fn cancellations(&self,
				                           _0: ::subxt::sp_core::H256,
				                           hash: ::core::option::Option<T::Hash>)
				                           -> ::core::result::Result<::core::primitive::bool, ::subxt::Error> {
		...
		pub mod storage {
			...
			impl<'a, T: ::subxt::Config> StorageApi<'a, T> {
				...
				pub async fn inbound_xcmp_messages_iter(
					&self,
					hash: ::core::option::Option<T::Hash>)
					-> ::core::result::Result<::subxt::KeyIter<'a, T, InboundXcmpMessages>, ::subxt::Error> {
					self.client.storage().iter(hash).await
				...
				pub async fn outbound_xcmp_messages_iter(
					&self,
					hash: ::core::option::Option<T::Hash>)
					-> ::core::result::Result<::subxt::KeyIter<'a, T, OutboundXcmpMessages>, ::subxt::Error> {
					self.client.storage().iter(hash).await
				}
	...
	pub mod polkadot_xcm {
		...
		pub mod calls {
				...
				where T: ::subxt::Config + ::subxt::ExtrinsicExtraData<T>
			{
				...
				pub fn reserve_transfer_assets(&self,
				                               dest: runtime_types::xcm::VersionedMultiLocation,
				                               beneficiary: runtime_types::xcm::VersionedMultiLocation,
				                               assets: runtime_types::xcm::VersionedMultiAssets,
				                               fee_asset_item: ::core::primitive::u32)
				...
				pub fn force_default_xcm_version(&self,
		...
		pub mod events {
			...
			#[derive(:: subxt :: codec :: Encode, :: subxt :: codec :: Decode)]
			pub struct ResponseReady(pub ::core::primitive::u64, pub runtime_types::xcm::v2::Response);
	...
	pub mod dmp_queue {
		...
		pub mod calls {
			...
			{
				pub fn new(client: &'a ::subxt::Client<T>) -> Self { Self { client } }
				pub fn service_overweight(&self,
		...
		pub mod storage {
			...
			impl ::subxt::StorageEntry for Pages {
				...
				type Value = ::std::vec::Vec<(::core::primitive::u32, ::std::vec::Vec<::core::primitive::u8>)>;
				fn key(&self) -> ::subxt::StorageEntryKey {
					:: subxt :: StorageEntryKey :: Map (vec ! [:: subxt :: StorageMapKey :: new (& self . 0 , :: subxt :: StorageHasher :: Blake2_128Concat)])
				}
			}
			...
			impl<'a, T: ::subxt::Config> StorageApi<'a, T> {
				...
				pub async fn configuration(
					&self,
					hash: ::core::option::Option<T::Hash>)
					-> ::core::result::Result<runtime_types::cumulus_pallet_dmp_queue::ConfigData, ::subxt::Error> {
		...
		pub mod calls {
				...
				where T: ::subxt::Config + ::subxt::ExtrinsicExtraData<T>
			{
				...
				pub fn publish_module(&self,
					...
					let call = PublishModule { module_bc, gas_limit };
					::subxt::SubmittableExtrinsic::new(self.client, call)
				}
	...
	pub mod multi_sig {
		...
		pub mod calls {
			...
			{
				pub fn new(client: &'a ::subxt::Client<T>) -> Self { Self { client } }
				pub fn as_multi_threshold1(&self,
	...
	pub mod runtime_types {
		...
		pub mod cumulus_pallet_dmp_queue {
			...
			#[derive(:: subxt :: codec :: CompactAs, :: subxt :: codec :: Encode, :: subxt :: codec :: Decode)]
		...
		pub mod pallet_sudo {
			...
			pub mod pallet {
				...
				pub enum Event {
					...
					#[codec(index = 2)]
					SudoAsDone(::core::result::Result<(), runtime_types::sp_runtime::DispatchError>),
				}
			}
		}
		...
		pub mod pallet_vesting {
			...
			pub mod pallet {
				...
				pub enum Event {
					#[codec(index = 0)]
					VestingUpdated(::subxt::sp_core::crypto::AccountId32, ::core::primitive::u64),
					#[codec(index = 1)]
		...
		pub mod pallet_xcm {
			...
			pub mod pallet {
				...
				pub enum Call {
					...
					#[codec(index = 4)]
					force_xcm_version {
						location: ::std::boxed::Box<runtime_types::xcm::v1::multilocation::MultiLocation>,
						xcm_version: ::core::primitive::u32,
					},
					#[codec(index = 5)]
		...
		pub mod parachain_staking {
			...
			pub mod pallet {
				...
				pub struct Collator2<_0, _1> {
					...
					pub top_nominators: ::std::vec::Vec<runtime_types::parachain_staking::pallet::Bond<_0, _1>>,
					pub bottom_nominators: ::std::vec::Vec<runtime_types::parachain_staking::pallet::Bond<_0, _1>>,
				...
				pub struct CollatorSnapshot<_0, _1> {
					pub bond: _1,
					pub nominators: ::std::vec::Vec<runtime_types::parachain_staking::pallet::Bond<_0, _1>>,
					pub total: _1,
				}
				#[derive(:: subxt :: codec :: Encode, :: subxt :: codec :: Decode)]
				...
				pub struct ExitQ<_0> {
					...
					pub nominator_schedule: ::std::vec::Vec<(_0, ::core::option::Option<_0>, ::core::primitive::u32)>,
				}
				#[derive(:: subxt :: codec :: Encode, :: subxt :: codec :: Decode)]
				...
				pub mod order {
					...
					pub enum Order {
						...
						ExchangeAsset {
							...
							receive: ::std::vec::Vec<runtime_types::xcm::v0::multi_asset::MultiAsset>,
						},
						#[codec(index = 4)]
	...
	impl ::subxt::Config for DefaultConfig {
		...
		type Header =
			::subxt::sp_runtime::generic::Header<Self::BlockNumber, ::subxt::sp_runtime::traits::BlakeTwo256>;
	...
	impl ::subxt::AccountData<DefaultConfig> for AccountData {
		...
		fn storage_entry(account_id: <DefaultConfig as ::subxt::Config>::AccountId) -> Self { Self(account_id) }
	}
	...
	impl<'a, T> StorageApi<'a, T> where T: ::subxt::Config + ::subxt::ExtrinsicExtraData<T> {
		pub fn system(&self) -> system::storage::StorageApi<'a, T> { system::storage::StorageApi::new(self.client) }
		pub fn randomness_collective_flip(&self) -> randomness_collective_flip::storage::StorageApi<'a, T> {
		...
		pub fn mvm(&self) -> mvm::storage::StorageApi<'a, T> { mvm::storage::StorageApi::new(self.client) }
	...
	impl<'a, T> TransactionApi<'a, T> where T: ::subxt::Config + ::subxt::ExtrinsicExtraData<T> {
		...
		pub fn mvm(&self) -> mvm::calls::TransactionApi<'a, T> { mvm::calls::TransactionApi::new(self.client) }
